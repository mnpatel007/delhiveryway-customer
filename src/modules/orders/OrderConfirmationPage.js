          ...
          <div className="order-confirmation-details">
              ...
              <div className="info-grid">
                <div className="info-item">
                  ...
                  <span className="info-value">
                    {order?.orderNumber || location.state?.orderNumber}
                  </span>
                </div>
                <div className="info-item">
                  <span className="info-label">Status:</span>
                  <span className="info-value status-badge">
                    {order?.status || 'pending_shopper'}
                  </span>
                </div>
                <div className="info-item">
            ...
            <div className="confirmation-section">
              ...
              <div className="address-display">
                ...
                {order.deliveryAddress.contactName || order.customerId?.name || 'N/A'}
                <br />
              ...
              <div className="next-steps">
                ...
                <div className="step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      The shopper will check item availability and may revise quantities if needed.
                    </p>
                  </div>
                </div>
                <div className="step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      You'll review and approve any changes before the shopper makes the purchase.
                    </p>
                  </div>
                </div>
                <div className="step">
